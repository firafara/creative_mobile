...
import 'package:creative_mobile/pages/service_report_tab/service_report_tab1.dart';
import 'package:creative_mobile/pages/service_report_tab/service_report_tab2.dart';
import 'package:creative_mobile/pages/service_report_tab/service_report_tab3.dart';
import 'package:creative_mobile/pages/service_report_tab/service_report_tab4.dart';
...
class _ServiceReportPageState extends State<ServiceReportPage> {
                ...
                children: <Widget>[
                  ...
                  Padding(
                    ...
                    child: TextFormField(
                      ...
                      decoration:
                          inputDecoration("Service Category", "Category"),
                    ),
                  ),
                  Padding(
                    padding: inputFieldPadding,
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: TextFormField(
                        ...
                        decoration:
                            inputDecoration('Unit Brand', 'Unit Brand')),
                  ),
                  Padding(
                    padding: inputFieldPadding,
                    child: TextFormField(
                        ...
                        decoration:
                            inputDecoration('Unit Model', 'Unit Model')),
                  ),
                  Padding(
                    padding: inputFieldPadding,
                    child: TextFormField(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: TextFormField(
                      ...
                      decoration:
                          inputDecoration('Report Creator', 'Report Creator'),
                      validator: (value) {
                        if (value == null || value.isEmpty) {
                  ...
                  Padding(
                    padding: const EdgeInsets.only(
                        bottom: 5, top: 10, right: 15, left: 10),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Theme(
        data: ThemeData(colorScheme: ColorScheme.light(primary: Colors.black)),
        child: Stepper(
